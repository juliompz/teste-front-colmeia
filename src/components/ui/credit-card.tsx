...
const validateCreditCard = (
  ...
  if (!value.cardholderName?.trim()) {
    errors.cardholderName = "Nome do titular do cartão é obrigatório";
  } else if (value.cardholderName.trim().length < 2) {
    errors.cardholderName = "Name deve ter pelo menos 2 caracteres";
  }
  ...
  if (!cleanCardNumber) {
    ...
    errors.cardNumber = "Número do cartão deve conter apenas dígitos";
  }
  ...
  if (!value.cvv?.trim()) {
    errors.cvv = `${cvvLabel} é obrigatório`;
  } else if (value.cvv.length !== expectedCvvLength) {
    errors.cvv = `${cvvLabel} deve ter ${expectedCvvLength} digitos`;
  } else if (!/^\d+$/.test(value.cvv)) {
    errors.cvv = `${cvvLabel} deve conter apenas digitos`;
  }
        ...
        >
              ...
              <div className="flex justify-between items-end">
                <div className="flex-1">
                  ...
                  <div className="font-bold text-sm">
                    {currentValue.cardholderName || "SEU NOME"}
                  </div>
                </div>
                  ...
                  <div className="font-bold text-sm">
                    {currentValue.expiryMonth && currentValue.expiryYear
                      ? `${
                        ...
                        }/${currentValue.expiryYear.slice(-2)}`
                      : "MM/AA"}
                  </div>
                </div>
          ...
          >
            ...
            <div className="text-xs opacity-60 text-center font-medium">
              Este cartão é protegido por recursos de segurança avançados
            </div>
          </Card>
        </motion.div>
      </div>
